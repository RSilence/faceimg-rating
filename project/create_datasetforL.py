...
class faceDataset(Dataset):
    def __init__(self, img_dir, rating_path=None, transform=None, train_or_test=None ):
    ...
    def __getitem__(self, idx):
        ...
        img_name = "SCUT-FBP-"+str(idx+1)+".jpg" if self.train_or_test == "train" else str('%06d' % (idx+1))+".jpg"
